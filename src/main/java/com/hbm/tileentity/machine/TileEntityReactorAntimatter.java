...
public class TileEntityReactorZirnox extends TileEntityMachineBase implements IControlReceiver, IFluidStandardTransceiver, SimpleComponent, IGUIProvider, IInfoProviderEC, CompatHandler.OCComponent {
	...
	private void checkIfMeltdown() {
		if (this.pressure > maxPressure || this.heat > maxHeat || this.magnet < minMagnet) {
			meltdown();
		}
	}
	...
	public FluidTank[] getReceivingTanks() {
		return new FluidTank[] { water, antimatter, liquidOxygen };
	}
	...
	@Callback(direct = true)
	@Optional.Method(modid = "OpenComputers")
	public Object[] getAntimatter(Context context, Arguments args) {
		return new Object[] {carbonDioxide.getFill()};
	}

  @Callback(direct = true)
	@Optional.Method(modid = "OpenComputers")
	public Object[] getMatter(Context context, Arguments args) {
		return new Object[] {carbonDioxide.getFill()};
	}
	...
	public Object[] invoke(String method, Context context, Arguments args) throws Exception {
      ...
      case ("setMagnet"):
			...
			case ("getAntimatter"):
				return getAntimatter(context, args);
			case ("getMatter"):
				return getMatter(context, args);
      case ("getValve"):
				return getValve(context, args);
      case ("setValve"):
				return setValve(context, args);
			case ("isActive"):
	...
	public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new ContainerReactorAntimatter(player.inventory, this);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public Object provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new GUIReactorAntimatter(player.inventory, this);
	}
    ...
    data.setDouble(CompatEnergyControl.D_ANTIMATTER_MB, output);
    data.setDouble(CompatEnergyControl.D_MATTER_MB, output);
	}
}
